...
class Mumble implements Plugin {
	...
	public function renderSidebar() {
		...
		startbox();
		echo '<iframe id = "mumbleIframe" src = "http://tydus.net/MumPI/viewer/"></iframe>';
		echo '<div class = "server">';
		echo '<script src = "resources/javascript/mumble.js" type = "text/javascript"></script>';
		echo '<p>Mumble is an open source, low-latency, high quality voice chat software primarily intended for use while gaming. <a href = "http://mumble.sourceforge.net/">Download Mumble.</a>';
