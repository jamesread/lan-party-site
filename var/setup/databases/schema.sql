...
--
-- Table structure for table `seatingplan_objects`
--

DROP TABLE IF EXISTS `seatingplan_objects`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seatingplan_objects` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `seatingplan_seats`
--

DROP TABLE IF EXISTS `seatingplan_seats`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seatingplan_seats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `x` int(11) DEFAULT NULL,
  `y` int(11) DEFAULT NULL,
  `user` int(11) DEFAULT NULL,
